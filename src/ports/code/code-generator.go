...
func NewCodeGenerator(cfg *models.Config, cmc modelhelper.CodeModelConverter) modelhelper.CodeGenerator {
	return &codeGenerator{cfg, cmc}
}

func (g *codeGenerator) GenerateCode(tpl *models.CodeTemplate, mdl interface{}) (*models.TemplateGeneratorFileResult, error) {
	if tpl == nil {
...
func (g *codeGenerator) Generate(ctx context.Context, options *models.CodeGeneratorOptions) ([]models.TemplateGeneratorFileResult, error) {
